import type { CompatibilityKey, DietLensKey, HealthBenefitKey } from "@/types/food";
...
export const DIET_LENSES: Lens[] = [
  ...
  { key: "mediterranean", label: "Mediterranean", accent: "56 189 255", group: "diet" },
  { key: "portfolio", label: "Portfolio", accent: "189 92 255", group: "diet" },
  { key: "keto", label: "Keto", accent: "255 196 0", group: "diet" },
  { key: "ayurvedic", label: "Ayurvedic", accent: "255 142 64", group: "diet" },
  { key: "gutHealthy", label: "Gut Healthy", accent: "0 230 168", group: "diet" },
  { key: "gerdFriendly", label: "GERD Friendly", accent: "255 86 86", group: "diet" },
];

/** Health-outcome lenses (inferred from tags & macros unless overridden). */
export const HEALTH_BENEFIT_LENSES: Lens[] = [
  { key: "immune", label: "Immune Support", accent: "120 255 180", group: "health" },
  { key: "energy", label: "Energy", accent: "255 220 80", group: "health" },
  { key: "antiInflammatory", label: "Anti-Inflammatory", accent: "255 120 80", group: "health" },
  { key: "brainHealth", label: "Brain & Memory", accent: "180 140 255", group: "health" },
  { key: "heartHealth", label: "Heart Health", accent: "255 80 120", group: "health" },
  { key: "cholesterol", label: "Cholesterol", accent: "100 200 255", group: "health" },
  { key: "digestion", label: "Digestion", accent: "80 220 160", group: "health" },
  { key: "satiety", label: "Satiety", accent: "200 180 255", group: "health" },
];
